...
export default function GradientText({
  children,
  className = '',
  colors = ['#6366f1', '#818cf8', '#c7d2fe', '#818cf8', '#6366f1'],
  animationSpeed = 8,
  showBorder = false,
  ...
  return (
    <motion.div
      className={`relative mx-auto flex max-w-fit flex-row items-center justify-center font-medium overflow-hidden ${showBorder ? 'py-1 px-2 rounded-[1.25rem]' : ''} ${className}`}
