          ...
          <div className={`px-8 pb-8 ${footerClassName}`}>
            ...
            >
              ...
              <button
                ...
                className="duration-350 flex items-center justify-center rounded-full bg-brand-500 py-1.5 px-3.5 font-medium tracking-tight text-white transition hover:bg-brand-600 active:bg-brand-700"
    ...
    >
      ...
      >
        {status === "complete" ? (
          ...
          <div className="h-3 w-3 rounded-full bg-[#0f1117]" />
        ) : (
