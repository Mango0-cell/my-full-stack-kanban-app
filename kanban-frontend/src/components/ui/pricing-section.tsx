...
const plans = [
  {
    name: "Starter",
    description: "Great for small businesses and startups looking to get started",
    price: 12,
    yearlyPrice: 99,
  ...
  return (
    ...
    >
      ...
      <TimelineContent
        ...
        className="absolute top-0 h-64 w-full overflow-hidden [mask-image:radial-gradient(50%_50%,white,transparent)]"
      >
      ...
      {/* Content */}
      <article className="text-center mb-4 md:mb-6 pt-8 md:pt-12 max-w-3xl mx-auto space-y-2 relative z-50 px-4">
      ...
      <div className="grid md:grid-cols-3 max-w-5xl gap-4 py-4 md:py-6 pb-6 md:pb-8 mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              ...
              <CardContent className="pt-0">
                <button
                  className={cn(
                    "w-full mb-6 p-3 text-lg rounded-xl",
                    plan.popular
                  ...
                  <ul className="space-y-2">
                    {plan.includes.slice(1).map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-center gap-2">
                        <span className="h-2 w-2 bg-neutral-500 rounded-full shrink-0" />
